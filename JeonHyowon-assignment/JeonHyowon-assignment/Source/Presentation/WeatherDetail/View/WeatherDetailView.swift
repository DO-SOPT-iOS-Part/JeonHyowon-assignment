...
final class WeatherDetailView: UIView {
    ...
    public let todayWeatherData: [TodayWeatherData] = [.init(hour: "Now", image: "icon_cloudy", temperature: "18°"),
    ...
    public var backgroundImageView = UIImageView().then {
    ...
    public var cityLabel = UILabel().then {
        $0.text = "서울특별시"
        $0.font = UIFont(name: "SFProDisplay-Regular", size: 36)
        $0.textColor = .white
    }
    
    public var currentTemperatureLabel = UILabel().then {
        $0.text = "21°"
        $0.font = UIFont(name: "SFProDisplay-Thin", size: 102)
        $0.textColor = .white
    }
    
    public var currentWeatherLabel = UILabel().then {
        $0.text = "흐림"
        $0.font = UIFont(name: "SFProDisplay-Regular", size: 24)
        $0.textColor = .white
    }
    
    public var temperatureLabel = UILabel().then {
        $0.text = "최고:29° 최저:15°"
        $0.font = UIFont(name: "SFProDisplay-Medium", size: 20)
        $0.textColor = .white
    }
    
    public var weatherDetailView = UIView().then {
    ...
    public var detailLabel = UILabel().then {
    ...
    public var separatorView = UIView().then {
        $0.backgroundColor = UIColor(red: 1, green: 1, blue: 1, alpha: 0.25)
    }
    
    public var collectionViewLayout = UICollectionViewFlowLayout().then {
    ...
    public lazy var collectionView = UICollectionView(frame: .zero, collectionViewLayout: collectionViewLayout).then {
    ...
    public var mapButton = UIButton().then {
        $0.setImage(UIImage(named: "icon_map"), for: .normal)
    }
    
    public var toolbarView = UIView().then {
        $0.layer.borderWidth = 0.5
        $0.layer.borderColor = UIColor(red: 1, green: 1, blue: 1, alpha: 0.25).cgColor
    }
